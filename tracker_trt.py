"""
    This file is a TensorRT version modified from `tracker.py`.
"""
import cv2
import numpy as np

from deep_sort.utils.parser import get_config
from deep_sort.deep_sort import DeepSortTRT

cfg = get_config()
cfg.merge_from_file("./deep_sort/configs/deep_sort.yaml")
deepsort = DeepSortTRT(cfg.DEEPSORT.REID_CKPT,
...
def draw_bboxes(image, bboxes, line_thickness, offset=0.6):
